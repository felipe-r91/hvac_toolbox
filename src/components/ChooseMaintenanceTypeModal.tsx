...
type Props = {
  ...
  onChooseHealthCheck: () => void;
  onChooseServiceReport: () => void;
  onChooseDaily: () => void;
};

export function ChooseMaintenanceTypeModal({ open, onClose, onChooseCfr, onChooseMachineMaintenance, onChooseHealthCheck, onChooseServiceReport, onChooseDaily }: Props) {
  return (
